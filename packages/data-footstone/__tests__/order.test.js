...
describe('Order', () => {
    beforeEach(() => {
        arr = ['5.3.5', '5.13.5', '5.5.5', '5.3.25', '5.3.15', '2.3.5', '3.3.5', '2.3.15', '6.23.5', '5.33.5']
    })
  test('versionOrder', () => {
    expect(versionOrder(arr)).toEqual([ "2.3.5", "2.3.15", "3.3.5", "5.3.5", "5.3.15", "5.3.25", "5.5.5", "5.13.5", "5.33.5", "6.23.5" ])
  })
})
